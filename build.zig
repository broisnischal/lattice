...
const default_native_sdk_path ="/home/nees/.config/nvm/versions/node/v24.13.0/lib/node_modules/@native-sdk/cli";
const app_exe_name = "reader";
...
pub fn build(b: *std.Build) void {
    ...
    if (selected_platform == .linux) {
        // Zig 0.16's self-hosted x86_64 backend + ELF linker cannot yet handle
        // the .sframe sections emitted in recent GCC/glibc crt objects
        // ("unhandled relocation type R_X86_64_PC64 ... crt1.o:.sframe").
        // The LLVM backend + LLD both handle them, so pin those on Linux.
        exe.use_llvm = true;
        exe.use_lld = true;
    }
